    ...
    <Row className="push-top--50">
      ...
      <Col lg={4} className="push-mob--top15">
        ...
        <div>
          <table
            id="foottable"
            style={{ fontSize: "22px", color: "#9ab4d3" }}
            width="100%"
          >
            <tbody>
              <tr>
                <td>
                  <a
                    ...
                    href="https://http://github.com/chaitanyapotti"
                  >
                ...
                <td>
                  <a
                    ...
                    className="opacity-70"
                    rel="noopener noreferrer"
                    href="https://www.twitter.com/ElectusNetwork"
                  >
      ...
      <Col className="text-right opacity-70 push--top fnt-ps">
        ©Electus Foundation 2018 all rights reserved
      </Col>
    </Row>
  </Grid>
  </div>

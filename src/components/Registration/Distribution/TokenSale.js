...
import { round1TokensChangedAction, round1RateChangedAction,
    round2TokensChangedAction, round2RateChangedAction, round3TokensChangedAction, round3RateChangedAction } from '../../../actions/projectRegistrationActions';
...
const mapStateToProps = state => {
    const { round1Tokens, round1Rate, round2Tokens, round2Rate,
...
const mapDispatchToProps = dispatch => {
    return bindActionCreators({
        ...
        round2RateChangedAction: round2RateChangedAction,

...
const panes = [
    { menuItem: 'Active DAICOs', render: () => <Tab.Pane attached={false}> <ActiveDaicos/></Tab.Pane> },
    { menuItem: 'Upcoming DAICOs', render: () => <Tab.Pane attached={false}><UpcomingDaicos/></Tab.Pane> },
    { menuItem: 'Ended DAICOs', render: () => <Tab.Pane attached={false}><EndedDaicos/></Tab.Pane> },
]
